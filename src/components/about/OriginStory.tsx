...
export function OriginStory() {
  ...
  return (
    <SectionWrapper 
      className="relative overflow-hidden bg-sage-mist py-12 md:py-16 lg:py-20 px-4 md:px-8"
    >
      <div ref={ref} className={cn("relative max-w-5xl mx-auto", animationClasses)}>
        <h2 className="font-headline text-3xl md:text-4xl lg:text-5xl font-bold mb-10 text-center tracking-tight text-foreground">
          Who We Serve
        </h2>

        <div className="grid items-stretch gap-8 lg:gap-12 lg:grid-cols-2">
          <Card className="group relative overflow-hidden border shadow-sm bg-card border-border hover:border-foreground/30 hover:backdrop-blur-md transition-all duration-500 ease-out h-full flex flex-col rounded-[16px]">
              ...
              {/* Bottom extending line animation */}
              <div className="absolute bottom-0 left-0 h-[3px] bg-foreground w-0 group-hover:w-full transition-all duration-500 ease-out" />
          </Card>
